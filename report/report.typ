...
В 90% случаев все внутренние метрики согласованы, но на границах областей заметны различия:
- *memory:* жестко тяготеет к *A*, что указывает на минимальный memory footprint данного подхода.
